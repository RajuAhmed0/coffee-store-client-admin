    ...
    return (
        <footer>
            <div
                ...
                style={{
                    backgroundImage: "url(https://i.ibb.co.com/MxGQRvLF/13.jpg)",
                }}
            >
                <div className="container mx-auto px-3 md:px-6">
                    <img
                        src="https://i.ibb.co.com/5xvvj0Qc/logo1.png"
                        alt="logo"
            ...
            <div
                className="py-2"
                style={{
                    backgroundImage: "url(https://i.ibb.co.com/s9mMQHft/24.jpg)",
                }}
            >
                <h1 className="text-white font-normal md:text-xl text-center">
                    Copyright Espresso Emporium Coffee  ! All Rights Reserved
                </h1>
            </div>
        </footer>
    );
